...
import static org.tensorflow.lite.examples.detection.CameraActivity.getTransformationMatrix;
...
public class MultiBoxTracker {
  ...
  public synchronized void draw(final Canvas canvas) {
    Log.v("CANVAS", String.valueOf(canvas.getWidth()));
    Log.v("CANVAS", String.valueOf(canvas.getHeight()));
